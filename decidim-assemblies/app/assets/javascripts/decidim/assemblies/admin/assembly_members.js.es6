((exports) => {
  const { createFieldDependentInputs, createAutocompleteSelect } = exports.DecidimAdmin;
  ...
  const assemblyMemberUserPickerSelector = "#assembly_member_user_id";

  createAutocompleteSelect(assemblyMemberUserPickerSelector);
})(window);
